...
const SearchFilters = ({ onFilterChange, onClearFilters, sidebarMode = false }) => {
    ...
    return (
        <div className={sidebarMode ? "bg-white overflow-hidden" : "bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6"}>
            {/* Header */}
            <div className="px-6 py-4 bg-gradient-to-r from-accent-50 to-accent-100 flex items-center justify-between">
                ...
                <button
                    ...
                    className="p-1 hover:bg-accent-200 rounded transition-colors"
                >
                    <svg
                        className={`w-5 h-5 text-accent-700 transition-transform ${isExpanded ? 'rotate-180' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                />
                                <svg className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-tertiary-500" fill="currentColor" viewBox="0 0 20 20">
